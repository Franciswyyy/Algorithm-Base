...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("wang.sortQuick.MergeSort02.MergeSort", arr1);
        SortTestHelper.testSort("wang.sortQuick.QuickSort02.QuickSort2Ways", arr2);
        SortTestHelper.testSort("wang.sortQuick.QuickSort03.QuickSort3Ways", arr3);
