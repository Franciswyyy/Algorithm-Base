...
public class BellmanFord<Weight extends Number & Comparable> {
    ...
    public static void main(String[] args) {
        ...
        //String filename = "F:\\Algorithm-Base\\src\\wang\\GraphWeightDirected\\testG2.txt";
        String filename = "F:\\Algorithm-Base\\src\\wang\\GraphWeightDirected\\testG_negative_circle.txt";
        int V = 5;
