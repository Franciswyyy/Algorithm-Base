package Algorithm.GraphWeightDirected;

import Algorithm.GraphWeight.Edge;
import Algorithm.GraphWeight.ReadWeightedGraph;
import Algorithm.GraphWeight.SparseWeightedGraph;
import Algorithm.GraphWeight.WeightedGraph;
...
public class BellmanFord<Weight extends Number & Comparable> {
    ...
    public static void main(String[] args) {
        ...
        //String filename = "F:\\Algorithm-Base\\src\\Algorithm\\GraphWeightDirected\\testG2.txt";
        String filename = "F:\\Algorithm-Base\\src\\Algorithm\\GraphWeightDirected\\testG_negative_circle.txt";
        int V = 5;
